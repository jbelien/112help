...
<html lang="en">
  ...
  <div id="content">
    ...
    <h1>IK BEN IN GEVAAR EN IK HEB HULP NODIG !*</h1>
    <p style="color:#f00; font-size:0.8em;">Opgelet: dit <span style="text-decoration:underline;">prototype</span> werkt niet in <strong>Google Chrome</strong>, want een gecodeerde verbinding is vereist.</p>
...
<?php } ?>
      <p id="loading">Geolocation waiting for permission and/or loading...</p>
      <div id="geolocation" style="display:none;">
        ...
        <div>
          <label for="acc">Nauwkeurigheid (m.) :</label>
        ...
        <div id="send">
          <button type="submit" name="action" value="send">IK STUUR MIJN POSITIE</button>
        </div>
      </div>
    </form>
