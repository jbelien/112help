...
<html lang="en">
  ...
  <div id="content">
    ...
    <p style="color:#f00; font-size:0.8em;">Attention: ce <span style="text-decoration:underline;">prototype</span> ne fonctionne pas sous <strong>Google Chrome</strong> qui n&eacute;cessite une connexion crypt&eacute;e.</p>
...
<?php } ?>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBkaDVJmpck53ed5VlwvloyVB-6HP6ApAE&callback=init" async defer></script>
  </body>
</html>
<!--
<?php
